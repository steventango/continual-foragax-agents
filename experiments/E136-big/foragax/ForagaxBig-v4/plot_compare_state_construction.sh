for fov in 5 9 15; do
    ...
    python src/learning_curve.py experiments/E136-big/foragax/ForagaxBig-v4 --plot-name compare_state_construction/dqn_fov${fov}_reward --filter-alg-aperture DQN_LN:${fov} DQN_LN_RT:${fov} Search-5 --metric rolling_reward_10000
done
