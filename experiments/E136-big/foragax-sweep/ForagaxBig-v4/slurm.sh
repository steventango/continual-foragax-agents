...
do
    ...
    python scripts/slurm.py --cluster clusters/vulcan-gpu-mps.json --time 03:00:00 --runs 5 --entry src/continuing_main.py --force -e experiments/E136-big/foragax-sweep/ForagaxBig-v4/${fov}/DRQN_1_1.json
    # python scripts/slurm.py --cluster clusters/vulcan-gpu-mps.json --time 03:00:00 --runs 5 --entry src/continuing_main.py --force -e experiments/E136-big/foragax-sweep/ForagaxBig-v4/${fov}/DRQN_0_2.json
    # python scripts/slurm.py --cluster clusters/vulcan-gpu-mps.json --time 03:00:00 --runs 5 --entry src/continuing_main.py --force -e experiments/E136-big/foragax-sweep/ForagaxBig-v4/${fov}/DRQN_LN_1_1.json
    # python scripts/slurm.py --cluster clusters/vulcan-gpu-mps.json --time 03:00:00 --runs 5 --entry src/continuing_main.py --force -e experiments/E136-big/foragax-sweep/ForagaxBig-v4/${fov}/DRQN_LN_0_2.json
done
