...
if __name__ == "__main__":
    ...
    plot_selection(ax, "PPO", 9, "", position=1, color_index=0, start_step=5_000_000, require_reward_trace=True)
    plot_selection(ax, "PPO", 5, "", position=2, color_index=1, start_step=5_000_000, require_reward_trace=True)
    plot_selection(ax, "PPO", 15, "", position=3, color_index=2, start_step=5_000_000, require_reward_trace=True)
    plot_selection(ax, "PPO", 9, "5M", position=4, color_index=3, start_step=5_000_000, require_reward_trace=True)
    plot_selection(ax, "PPO", 5, "5M", position=5, color_index=4, start_step=5_000_000, require_reward_trace=True)
    plot_selection(ax, "PPO", 15, "5M", position=6, color_index=5, start_step=5_000_000, require_reward_trace=True)
