...
python scripts/slurm.py --cluster clusters/vulcan-cpu-1h.json --runs 5 --entry src/continuing_main.py --force -e experiments/E99-weather/foragax-sweep/ForagaxTwoBiome-v5/9/DQN_CReLU.json
