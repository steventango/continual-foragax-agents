...
if __name__ == "__main__":
    ...
    plot_selection(ax, "PPO", 15, "5M", color_index=0, require_reward_trace=True)
    plot_selection(ax, "PPO", 9, "5M", color_index=1, require_reward_trace=True)
    plot_selection(ax, "PPO", 5, "5M", color_index=2, require_reward_trace=True)
    plot_selection(ax, "RTU", 15, "5M", color_index=3)
    plot_selection(ax, "RTU", 9, "5M", color_index=4)
    plot_selection(ax, "RTU", 5, "5M", color_index=5)
