...
python scripts/slurm.py --cluster clusters/vulcan-cpu-1h.json --runs 30 --entry src/continuing_main.py --force -e experiments/E26-search-limited-fov/foragax/ForagaxTwoBiome-v2/Baselines/Search-Nearest.json
...
python scripts/slurm.py --cluster clusters/vulcan-cpu-1h.json --runs 30 --entry src/continuing_main.py --force -e experiments/E26-search-limited-fov/foragax/ForagaxTwoBiome-v2/Baselines/Search-Oyster.json
