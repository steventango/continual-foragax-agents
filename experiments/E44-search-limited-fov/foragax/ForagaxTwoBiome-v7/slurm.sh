...
python scripts/slurm.py --cluster clusters/vulcan-cpu-30m.json --runs 30 --entry src/continuing_main.py --force -e experiments/E44-search-limited-fov/foragax/ForagaxTwoBiome-v7/Baselines/Search-Brown-Avoid-Green.json
