...
python scripts/slurm.py --cluster clusters/vulcan-gpu-vmap-15m.json --runs 5 --entry src/continuing_main.py --force -e experiments/foragax-sweep/ForagaxWeather-v1/ForagaxWeather-v1-3/DQN_small_buffer.json
python scripts/slurm.py --cluster clusters/vulcan-gpu-vmap-30m.json --runs 5 --entry src/continuing_main.py --force -e experiments/foragax-sweep/ForagaxWeather-v1/ForagaxWeather-v1-5/DQN_small_buffer.json
python scripts/slurm.py --cluster clusters/vulcan-gpu-vmap-30m.json --runs 5 --entry src/continuing_main.py --force -e experiments/foragax-sweep/ForagaxWeather-v1/ForagaxWeather-v1-7/DQN_small_buffer.json
python scripts/slurm.py --cluster clusters/vulcan-gpu-vmap-30m.json --runs 5 --entry src/continuing_main.py --force -e experiments/foragax-sweep/ForagaxWeather-v1/ForagaxWeather-v1-9/DQN_small_buffer.json
python scripts/slurm.py --cluster clusters/vulcan-gpu-vmap-45m.json --runs 5 --entry src/continuing_main.py --force -e experiments/foragax-sweep/ForagaxWeather-v1/ForagaxWeather-v1-11/DQN_small_buffer.json
python scripts/slurm.py --cluster clusters/vulcan-gpu-vmap-45m.json --runs 5 --entry src/continuing_main.py --force -e experiments/foragax-sweep/ForagaxWeather-v1/ForagaxWeather-v1-13/DQN_small_buffer.json
python scripts/slurm.py --cluster clusters/vulcan-gpu-vmap-1h.json --runs 5 --entry src/continuing_main.py --force -e experiments/foragax-sweep/ForagaxWeather-v1/ForagaxWeather-v1-15/DQN_small_buffer.json
...
python scripts/slurm.py --cluster clusters/vulcan-gpu-vmap-15m.json --runs 5 --entry src/continuing_main.py --force -e experiments/foragax-sweep/ForagaxWeather-v1/ForagaxWeather-v1-3/DQN_L2_Init_small_buffer.json
python scripts/slurm.py --cluster clusters/vulcan-gpu-vmap-30m.json --runs 5 --entry src/continuing_main.py --force -e experiments/foragax-sweep/ForagaxWeather-v1/ForagaxWeather-v1-5/DQN_L2_Init_small_buffer.json
python scripts/slurm.py --cluster clusters/vulcan-gpu-vmap-30m.json --runs 5 --entry src/continuing_main.py --force -e experiments/foragax-sweep/ForagaxWeather-v1/ForagaxWeather-v1-7/DQN_L2_Init_small_buffer.json
python scripts/slurm.py --cluster clusters/vulcan-gpu-vmap-30m.json --runs 5 --entry src/continuing_main.py --force -e experiments/foragax-sweep/ForagaxWeather-v1/ForagaxWeather-v1-9/DQN_L2_Init_small_buffer.json
python scripts/slurm.py --cluster clusters/vulcan-gpu-vmap-45m.json --runs 5 --entry src/continuing_main.py --force -e experiments/foragax-sweep/ForagaxWeather-v1/ForagaxWeather-v1-11/DQN_L2_Init_small_buffer.json
python scripts/slurm.py --cluster clusters/vulcan-gpu-vmap-45m.json --runs 5 --entry src/continuing_main.py --force -e experiments/foragax-sweep/ForagaxWeather-v1/ForagaxWeather-v1-13/DQN_L2_Init_small_buffer.json
python scripts/slurm.py --cluster clusters/vulcan-gpu-vmap-1h.json --runs 5 --entry src/continuing_main.py --force -e experiments/foragax-sweep/ForagaxWeather-v1/ForagaxWeather-v1-15/DQN_L2_Init_small_buffer.json
...
python scripts/slurm.py --cluster clusters/vulcan-cpu-15m.json --runs 5 --entry src/continuing_main.py --force -e experiments/foragax-sweep/ForagaxWeather-v1/ForagaxWeather-v1-15/Search-Oyster.json
