...
COLORS = {
    ...
    # "DRQN-9": "#8b8cff",
    # "DRQN-11": "#b260ff",
    # "ATAADRQN-long-9": "#d72dff",
    # "ATAADRQN-9": "#ff00ff",
    # "AADRQN-long-9":  "#7fff7f",  # Light green
    # "AADRQN-9":  "#40e0d0",  # Turquoise
    # "DRQN-long-9":  "#00ced1",  # Dark turquoise
    # "DRQN-9":  "#20b2aa",  # Light sea green
    "DQN-taper-15": "#00ffff",  # Teal
    "DQN-15": "#3ddcff",  # Deep teal
    "ATAADRQN-taper-15": "#57abff",
    "AADRQN-taper-15": "#8b8cff",  # Deep goldenrod
    "DRQN-taper-15": "#b260ff",  # Firebrick red
    "Random": "black",
}
