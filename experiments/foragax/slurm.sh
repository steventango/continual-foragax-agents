python scripts/slurm.py --cluster clusters/fir-t1-c8-m2-s4.json --runs 30  --entry src/continuing_main.py -f -e experiments/foragax/ForagaxTwoBiomeSmall-3/DQN.json
python scripts/slurm.py --cluster clusters/fir-t1-c8-m2-s4.json --runs 30  --entry src/continuing_main.py -f -e experiments/foragax/ForagaxTwoBiomeSmall-3/EQRC.json
python scripts/slurm.py --cluster clusters/fir-t1-c8-m2-s4.json --runs 30  --entry src/continuing_main.py -f -e experiments/foragax/ForagaxTwoBiomeSmall-5/DQN.json
python scripts/slurm.py --cluster clusters/fir-t1-c8-m2-s4.json --runs 30  --entry src/continuing_main.py -f -e experiments/foragax/ForagaxTwoBiomeSmall-5/EQRC.json
python scripts/slurm.py --cluster clusters/fir-t1-c8-m2-s2.json --runs 30  --entry src/continuing_main.py -f -e experiments/foragax/ForagaxTwoBiomeSmall-7/DQN.json
python scripts/slurm.py --cluster clusters/fir-t1-c8-m2-s2.json --runs 30  --entry src/continuing_main.py -f -e experiments/foragax/ForagaxTwoBiomeSmall-7/EQRC.json
