...
python scripts/slurm.py --cluster clusters/vulcan-cpu-3h.json --runs 30 --entry src/continuing_main.py --force -e experiments/foragax/ForagaxTwoBiome-v1/ForagaxTwoBiome-v1-15/Search-Morel-Avoid-Green.json
python scripts/slurm.py --cluster clusters/vulcan-cpu-3h.json --runs 30 --entry src/continuing_main.py --force -e experiments/foragax/ForagaxTwoBiome-v1/ForagaxTwoBiome-v1-15/Search-Morel.json
...
python scripts/slurm.py --cluster clusters/vulcan-cpu-3h.json --runs 30 --entry src/continuing_main.py --force -e experiments/foragax/ForagaxTwoBiome-v1/ForagaxTwoBiome-v1-15/Search-Oracle.json
python scripts/slurm.py --cluster clusters/vulcan-cpu-3h.json --runs 30 --entry src/continuing_main.py --force -e experiments/foragax/ForagaxTwoBiome-v1/ForagaxTwoBiome-v1-15/Search-Oyster.json
