python scripts/slurm.py --cluster clusters/vulcan-cpu-2h.json --runs 30 --entry src/continuing_main.py --force -e experiments/result-search-vs-limited-fov-2-biome/foragax/ForagaxTwoBiome-v1/7/DQN.json
