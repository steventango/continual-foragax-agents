...
python src/learning_curve.py experiments/E124-diwali/foragax/ForagaxDiwali-v4 --plot-name fig1b_diwali_frozen --filter-alg-apertures PPO:5 PPO-RTU:5 PPO_frozen_5M:5 PPO-RTU_frozen_5M:5
python src/learning_curve.py experiments/E124-diwali/foragax/ForagaxDiwali-v4 --plot-name fig1b_diwali_ppo_frozen_seeds --filter-alg-apertures PPO:5 PPO_frozen_5M:5 --subplot-by-seed
python src/learning_curve.py experiments/E124-diwali/foragax/ForagaxDiwali-v4 --plot-name fig1b_diwali_rtu_frozen_seeds --filter-alg-apertures PPO-RTU:5 PPO-RTU_frozen_5M:5 --subplot-by-seed
