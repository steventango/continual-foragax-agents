python scripts/slurm.py --cluster clusters/vulcan-cpu-3h.json --runs 30 --entry src/continuing_main.py --force -e experiments/E69-search-limited-fov/foragax/ForagaxTwoBiome-v10/9/DQN.json
