...
COLORS = {
    "RealTimeActorCriticConvPooling-3": "#1f77b4",        # Muted blue
    "RealTimeActorCriticConvPoolingNE-3": "#2ca02c",     # Muted green
    "RealTimeActorCriticConvPooling-7": "#d62728",   # Muted red
    "RealTimeActorCriticConvPoolingNE-7": "#9467bd",      # Muted purple
