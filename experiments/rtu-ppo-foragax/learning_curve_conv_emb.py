...
COLORS = {
    "RealTimeActorCriticConvEmb-3": "#1f77b4",        # Muted blue
    "RealTimeActorCriticConvEmbNE-3": "#2ca02c",     # Muted green
    "RealTimeActorCriticConvEmb-7": "#d62728",   # Muted red
    "RealTimeActorCriticConvEmbNE-7": "#9467bd",      # Muted purple
    "RealTimeActorCriticConvEmb-11": "#ff7f0e", # Muted orange
    "RealTimeActorCriticConvEmbNE-11": "#8c564b", # Muted brown
    "Random": "#7f7f7f",                           # Gray
}
