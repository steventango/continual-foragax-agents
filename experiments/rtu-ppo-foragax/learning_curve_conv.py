...
COLORS = {
    ...
    "RealTimeActorCriticConvNE-3": "#2ca02c",     # Muted green
    "RealTimeActorCriticConv-7": "#d62728",   # Muted red
    "RealTimeActorCriticConvNE-7": "#9467bd",      # Muted purple
    "RealTimeActorCriticConv-11": "#ff7f0e", # Muted orange
    "RealTimeActorCriticConvNE-11": "#8c564b", # Muted brown
    "Random": "#7f7f7f",                           # Gray
}
