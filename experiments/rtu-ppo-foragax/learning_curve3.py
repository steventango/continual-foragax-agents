...
COLORS = {
    "RTU-PPO-3": "#1f77b4",  # Muted blue
    "RTU-PPO-7": "#2ca02c",  # Muted green
    "RTU-PPO-11": "#d62728",  # Muted red
    "Random": "#7f7f7f",  # Gray
}
...
if __name__ == "__main__":
    ...
    ax.axhline(y=1.2, label="Oracle", color="#9467bd")  # Muted purple
    ...
    for env_aperture, sub_results in sorted(
        ...
        for alg_result in sub_results:
            ...
            if len(ys) >= 5:
                ...
                for y in ys:
                    ax.plot(xs[0], y, color=COLORS[label], linestyle=LINESTYLES[label], linewidth=0.2)
