...
if __name__ == "__main__":
    ...
    def plot_selection(ax, family: str, aperture: int | None, desired_variant: str | None, require_l2: bool=False, require_reward_trace: bool=False, require_sinusoidal: bool=False, color_index:int=0):
    ...
    plot_selection(ax, "PPO", 9, "5M", color_index=1)
    plot_selection(ax, "PPO", 15, "", color_index=2)
    plot_selection(ax, "PPO", 15, "5M", color_index=3)
    ax.ticklabel_format(axis="x", style="sci", scilimits=(0, 0), useMathText=True)
    ax.set_xlabel("Time steps")
    ax.set_ylabel("Average Reward")
    ax.set_title(f"{env} — Reward Delay 10000: PPO")
    ax.set_ylim(-1.5,1.5)
    ...
    plot_selection(ax, "SINGLE:Search-Brown-Avoid-Green", None, "", color_index=-2)
    # RTU/PPO at FOV 9 and 15 (base, non-frozen)
    plot_selection(ax, "PPO", 9, "", require_reward_trace=True, color_index=0)
    plot_selection(ax, "PPO", 9, "5M", require_reward_trace=True, color_index=1)
    plot_selection(ax, "PPO", 15, "", require_reward_trace=True, color_index=2)
    plot_selection(ax, "PPO", 15, "5M", require_reward_trace=True, color_index=3)
    ax.ticklabel_format(axis="x", style="sci", scilimits=(0, 0), useMathText=True)
    ax.set_xlabel("Time steps")
    ax.set_ylabel("Average Reward")
    ax.set_title(f"{env} — Reward Delay 10000: PPO Reward Trace")
    ax.set_ylim(-1.5,1.5)
    ax.spines["top"].set_visible(False)
    ax.spines["right"].set_visible(False)
    ax.legend(ncol=1, loc="best", frameon=False, fontsize=12)
    ...
    plot_selection(ax, "RTU", 9, "5M", color_index=1)
    plot_selection(ax, "RTU", 15, "", color_index=2)
    plot_selection(ax, "RTU", 15, "5M", color_index=3)
    ax.ticklabel_format(axis="x", style="sci", scilimits=(0, 0), useMathText=True)
    ax.set_xlabel("Time steps")
    ax.set_ylabel("Average Reward")
    ax.set_title(f"{env} — Reward Delay 10000: RTU PPO")
    ax.set_ylim(-1.5,1.5)
    ax.spines["top"].set_visible(False)
    ax.spines["right"].set_visible(False)
    ax.legend(ncol=1, loc="best", frameon=False, fontsize=12)
    ...
    # plot_selection(ax, "SINGLE:Search-Brown-Avoid-Green", None, "", color_index=-2)
    # # RTU/PPO at FOV 9 and 15 (base, non-frozen)
    # plot_selection(ax, "RTU", 9, "", color_index=0, require_sinusoidal=True)
    # plot_selection(ax, "PPO", 9, "", color_index=1, require_sinusoidal=True)
    # plot_selection(ax, "RTU", 15, "", color_index=2, require_sinusoidal=True)
    # plot_selection(ax, "PPO", 15, "", color_index=3, require_sinusoidal=True)
    # ax.ticklabel_format(axis="x", style="sci", scilimits=(0, 0), useMathText=True)
    # ax.set_xlabel("Time steps")
    # ax.set_ylabel("Average Reward")
