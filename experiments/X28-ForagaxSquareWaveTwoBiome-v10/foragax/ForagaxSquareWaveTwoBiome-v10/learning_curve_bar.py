...
if __name__ == "__main__":
    ...
    plot_selection(ax, "PPO", 9, "", position=1, color_index=0)
    plot_selection(ax, "PPO", 9, "", position=2, color_index=2, require_reward_trace=True)
    plot_selection(ax, "PPO-Conv", 9, "", position=3, color_index=3, require_reward_trace=True)
    plot_selection(ax, "RTU", 9, "", position=4, color_index=4)
    plot_selection(ax, "RTU-Conv", 9, "", position=5, color_index=5)
