rsync -azP --include='*/' --include='*.parquet' --exclude='*' vulcan:/home/stang5/scratch/continual-foragax-agents/results .
rsync -azP --include='*/' --include='videos/0/*.mp4' --exclude='*' vulcan:/home/stang5/scratch/continual-foragax-agents/results .
