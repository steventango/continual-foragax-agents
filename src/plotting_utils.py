...
LABEL_MAP: Dict[str, str] = {
    ...
    "DQN_ReDo": "DQN (ReDo)",
    "DQN_ReDo_PreActLN": "DQN (ReDo + Pre-Act LN)",
    "DQN_ReDo_PostLNScore": "DQN (ReDo + Post-LN Score)",
...
COLOR_MAP: Dict[str, Any] = {
    ...
    "DQN_ReDo": _muted.rose,
    "DQN_ReDo_PreActLN": _muted.sand,
    "DQN_ReDo_PostLNScore": _muted.wine,
    "DRQN": "black",
    "DRQN_B32": _vibrant.grey,
    ...
    "DQN (ReDo)": _muted.rose,
    "DQN (ReDo + Pre-Act LN)": _muted.sand,
    "DQN (ReDo + Post-LN Score)": _muted.wine,
    "DRQN": "black",
    "DRQN (B=32)": _vibrant.grey,
